...
class UserInfoPage2 extends StatefulWidget {
  ...
  const UserInfoPage2({Key? key, required this.email}) : super(key: key);

  @override
  State<UserInfoPage2> createState() => _UserInfoPageState2();
}

class _UserInfoPageState2 extends State<UserInfoPage2> {
